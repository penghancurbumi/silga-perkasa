                ...
                <tr class="hover:bg-gray-50"> 
                    ...
                    <td class="px-4 py-2">
                        <div class="flex items-center">
                            <p class="text-sm font-medium text-black truncate">{{ $lowongan->title }}</p>
                        </div>
                    </td>
                    <td class="px-4 py-2">
                        <span class="text-sm text-black">{{ $lowongan->category }}</span>
                    </td>
                    <td class="px-4 py-2">
                        <span class="text-sm text-black">{{ $lowongan->location }}</span>
                    </td>
                    <td class="px-4 py-2">
                        <span class="text-sm text-black capitalize">{{ $lowongan->employment_type }}</span>
                    </td>
                    <td class="px-4 py-2">
                    ...
                    <td class="px-4 py-2">
                        <span class="text-sm text-black">{{ $lowongan->deadline ? \Carbon\Carbon::parse($lowongan->deadline)->format('d M Y') : '-' }}</span>
                    </td>
                </tr>
                @empty
                <tr>
